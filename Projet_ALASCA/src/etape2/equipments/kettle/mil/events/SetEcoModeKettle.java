...
// -----------------------------------------------------------------------------
/**
 * The class <code>SetEcoModeKettle</code> defines the simulation event of
 * setting the kettle (water heater) to ECO mode (1000W).
 *
 * <p>Created on : 2026-02-06</p>
 */
public class			SetEcoModeKettle
extends		ES_Event
implements	KettleEventI
{
	private static final long serialVersionUID = 1L;

	public				SetEcoModeKettle(Time timeOfOccurrence)
	{
