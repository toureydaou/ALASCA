...
// -----------------------------------------------------------------------------
/**
 * The class <code>SetMaxModeKettle</code> defines the simulation event of
 * setting the kettle (water heater) to MAX mode (3000W).
 *
 * <p>Created on : 2026-02-06</p>
 */
public class			SetMaxModeKettle
extends		ES_Event
implements	KettleEventI
{
	private static final long serialVersionUID = 1L;

	public				SetMaxModeKettle(Time timeOfOccurrence)
	{
