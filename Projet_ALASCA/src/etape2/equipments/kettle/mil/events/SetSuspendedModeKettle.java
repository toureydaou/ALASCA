...
// -----------------------------------------------------------------------------
/**
 * The class <code>SetSuspendedModeKettle</code> defines the simulation event
 * of setting the kettle (water heater) to SUSPEND mode (0W).
 *
 * <p>Created on : 2026-02-06</p>
 */
public class			SetSuspendedModeKettle
extends		ES_Event
implements	KettleEventI
{
	private static final long serialVersionUID = 1L;

	public				SetSuspendedModeKettle(Time timeOfOccurrence)
	{
	...
	public void			executeOn(AtomicModelI model)
	{
		...
		assert	kettle.getState() != KettleState.OFF :
				new NeoSim4JavaException(
						...
						+ "KettleState.OFF");
		kettle.setMode(KettleMode.SUSPEND);
	}
}
// -----------------------------------------------------------------------------
