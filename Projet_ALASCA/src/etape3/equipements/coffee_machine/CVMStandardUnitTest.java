 ...
 */
public class CVMStandardUnitTest extends AbstractCVM {
	// -------------------------------------------------------------------------
...
//											ExecutionMode.STANDARD;
	...
	public static String START_INSTANT = "2026-10-08T08:00:00.00Z";

	// -------------------------------------------------------------------------
	// Constructors
	// -------------------------------------------------------------------------

	public CVMStandardUnitTest() throws Exception {
	...
	public static void main(String[] args) {
		try {
			...
			CVMStandardUnitTest cvm = new CVMStandardUnitTest();
	...
	public static TestScenario unitTestScenario() throws VerboseException {
		...
		Instant fillWaterInstant = startInstant.plusSeconds(120);
		Instant setEcoModeInstant = startInstant.plusSeconds(3600);
		Instant setNormalModeInstant = startInstant.plusSeconds(7200);
		Instant setMaxModeInstant = startInstant.plusSeconds(10800);
		Instant startHeatingInstant = startInstant.plusSeconds(14400);
		Instant makeExpressoInstant = startInstant.plusSeconds(18000);
		Instant stopHeatingInstant = startInstant.plusSeconds(19800);
