...
@SIL_Simulation_Architectures({
    @LocalArchitecture(
        uri = "silUnitTests",
        rootModelURI = "CoffeeMachineCoupledModel",
...
public class CoffeeMachineCyPhy 
...
implements CoffeeMachineUserI, CoffeeMachineInternalControlI, CoffeeMachineExternalControlI {
    ...
    public static final Measure<Double> SUSPENDED_POWER_IN_WATTS = new Measure<>(Constants.SUSPENDED_MODE_POWER, POWER_UNIT);
    ...
    protected CoffeeMachineCyPhy(
        ...
        this(AbstractPort.generatePortURI(CyPhyReflectionCI.class),
             userInboundPortURI, internalControlInboundPortURI,
             externalControlInboundPortURI, sensorInboundPortURI,
    ...
    protected CoffeeMachineCyPhy(
        ...
        this.initialise(userInboundPortURI, internalControlInboundPortURI,
                       externalControlInboundPortURI, sensorInboundPortURI,
                       actuatorInboundPortURI);
    }
    ...
    protected CoffeeMachineCyPhy(
        ...
        this(AbstractPort.generatePortURI(CyPhyReflectionCI.class),
             userInboundPortURI, internalControlInboundPortURI,
             externalControlInboundPortURI, sensorInboundPortURI,
             actuatorInboundPortURI, executionMode, clockURI);
    }
        ...
        try {
            ...
            case INTEGRATION_TEST_WITH_SIL_SIMULATION:
                RTArchitecture architecture =
                    (RTArchitecture) this.localSimulationArchitectures.get(this.localArchitectureURI);
    ...
    public void execute() throws Exception {
        ...
        case INTEGRATION_TEST:
            ...
            this.currentPowerLevel = new TimedMeasure<>(0.0, POWER_UNIT,
                                                        this.getClock(), this.getClock().getStartInstant());
            this.currentTemperature = new TimedMeasure<>(MIN_TEMPERATURE.getData(), TEMPERATURE_UNIT,
                                                         this.getClock(), this.getClock().getStartInstant());
            this.currentWaterLevel = new TimedMeasure<>(INITIAL_WATER_LEVEL.getData(), LITERS,
                                                        this.getClock(), this.getClock().getStartInstant());
        ...
        case UNIT_TEST_WITH_SIL_SIMULATION:
            ...
            this.asp.startRTSimulation(
                TimeUnit.NANOSECONDS.toMillis(this.getClock4Simulation().getStartEpochNanos()),
    ...
    protected RTArchitecture createLocalSimulationArchitecture(
        ...
        if (architectureURI.equals(UNIT_TEST_ARCHITECTURE_URI)) {
            ret = Local_SIL_SimulationArchitectures.createCoffeeMachineSIL_Architecture4UnitTest(
    ...
    public boolean on() throws Exception {
        ...
        return this.currentState == CoffeeMachineState.ON || 
    ...
    public void setMode(int mode) throws Exception {
        switch(mode) {
            case 1: setSuspendMode(); break;
            case 2: setEcoMode(); break;
            case 3: setNormalMode(); break;
            case 4: setMaxMode(); break;
        }
    }
    ...
    public void makeExpresso() throws Exception {
        ...
        if (this.getExecutionMode().isSILTest()) {
            ...
            // After heating is done, trigger ServeCoffee to dispense coffee
            // This would typically be handled by the simulation model timing
        } else {
    ...
    public Measure<Double> getTemperature() throws Exception {
        ...
        if (this.executionMode.isSILTest()) {
            ...
            temp = new Measure<>(this.currentTemperature.getData(),
                               this.currentTemperature.getMeasurementUnit());
        }
        return temp;
    }
    ...
    public void setCurrentPowerLevel(Measure<Double> powerLevel) throws Exception {
        ...
        if (powerLevel.getData() <= getMaxPowerLevel().getData()) {
            this.currentPowerLevel = new TimedMeasure<>(
                powerLevel.getData(), powerLevel.getMeasurementUnit());
        } else {
            this.currentPowerLevel = new TimedMeasure<>(
                HIGH_POWER_IN_WATTS.getData(), HIGH_POWER_IN_WATTS.getMeasurementUnit());
        }
    }
    ...
    public Measure<Double> getPowerLevel() throws Exception {
        ...
        return new Measure<>(this.currentPowerLevel.getData(), 
                            this.currentPowerLevel.getMeasurementUnit());
    }
    ...
    public TemperatureSensorData temperaturePullSensor() throws Exception {
        ...
        case INTEGRATION_TEST:
            ret = new TemperatureSensorData(
                new TimedMeasure<>(
                    this.currentTemperature.getData(),
                    this.currentTemperature.getMeasurementUnit(),
                    this.getClock(),
                    this.currentTemperature.getTimestamp()));
            break;
        case UNIT_TEST_WITH_SIL_SIMULATION:
        case INTEGRATION_TEST_WITH_SIL_SIMULATION:
            VariableValue<Double> v = this.computeCurrentTemperature();
            ret = new TemperatureSensorData(
                new TimedMeasure<>(v.getValue(), TEMPERATURE_UNIT,
                                  this.getClock4Simulation(),
    ...
    public WaterLevelSensorData waterLevelPullSensor() throws Exception {
        ...
        case INTEGRATION_TEST:
            ret = new WaterLevelSensorData(
                new TimedMeasure<>(
                    this.currentWaterLevel.getData(),
        ...
        case INTEGRATION_TEST_WITH_SIL_SIMULATION:
            ...
            ret = new WaterLevelSensorData(
                new TimedMeasure<>(v.getValue(), LITERS,
                                  this.getClock4Simulation(),
                                  this.getClock4Simulation().instantOfSimulatedTime(v.getTime())));
            break;
        default:
     ...
     * 
     * <p>
     * This method is called by the {@code get} method of the inbound port
     * to retrieve all sensor data at once in the pull protocol. It aggregates
     * the state, mode, temperature, and water level into a single compound
     * sensor data object.
     * </p>
     * 
     * <p><strong>Contract</strong></p>
    ...
    public CoffeeMachineCompoundSensorData sensorDataCompound() throws Exception {
        return new CoffeeMachineCompoundSensorData(
            this.statePullSensor(),
            this.modePullSensor(),
            this.temperaturePullSensor(),
            this.waterLevelPullSensor()
        );
    }
    ...
    protected void sensorDataPush() throws Exception {
        CoffeeMachineCompoundSensorData data = new CoffeeMachineCompoundSensorData(
            this.statePullSensor(),
            this.modePullSensor(),
            this.temperaturePullSensor(),
            this.waterLevelPullSensor()
