 ...
 * for the kettle component (no simulation).
 *
...
public class CVMStandardUnitTest extends AbstractCVM {
	...
	public static TestScenario unitTestScenario() throws VerboseException {
		...
		Instant setMaxModeInstant = startInstant.plusSeconds(3600);
		Instant startHeatingInstant = startInstant.plusSeconds(7200);
		Instant stopHeatingInstant = startInstant.plusSeconds(10800);
