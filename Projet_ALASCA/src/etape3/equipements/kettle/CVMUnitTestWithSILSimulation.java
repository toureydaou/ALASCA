 ...
 * for the kettle component with SIL simulation.
 *
...
public class CVMUnitTestWithSILSimulation extends AbstractCVM {
	...
	public static TestScenario unitTestScenario() throws VerboseException {
		...
		Instant setMaxModeInstant = startInstant.plusSeconds(1200);
		Instant startHeatingInstant = startInstant.plusSeconds(1800);
		Instant stopHeatingInstant = startInstant.plusSeconds(8700);
