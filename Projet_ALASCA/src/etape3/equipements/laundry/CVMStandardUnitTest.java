...
// -----------------------------------------------------------------------------
/**
 * The class <code>CVMStandardUnitTest</code> performs standard unit tests
 * for the laundry machine component (no simulation).
 *
...
public class CVMStandardUnitTest extends AbstractCVM {
	...
	public static TestScenario unitTestScenario() throws VerboseException {
		...
		Instant setDelicateModeInstant = startInstant.plusSeconds(3600);
		Instant setColorModeInstant = startInstant.plusSeconds(7200);
		Instant startWashInstant = startInstant.plusSeconds(10800);
		Instant cancelWashInstant = startInstant.plusSeconds(14400);
